...
/** 
    ...
    public function get_gallery_all_program(Request $request,$idGenre){
        ...
        $content = \DB::table('tbl_program_periode as a')->selectRaw('
            ...
            ->leftJoin('tbl_content_copp as d','d.id_program_periode','a.id_program_periode')
    ...
    public function get_image(Request $request){
        ...
        $content = \DB::table('tbl_content_copp as a')->selectRaw('*')
    ...
    public function get_special_offers(Request $request){
        ...
        ->leftJoin('tbl_content_copp as b','b.id_program_periode','a.id_salestools')
